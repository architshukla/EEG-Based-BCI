...
#pragma comment(lib, "C:/SystemSetup/Emotiv Research Edition SDK v2.0.0.20/doc/examples/lib/edk.lib")
...
int main(int argc, char** argv) {
	...
	try {
		...
		std::cout << "===================================================================" << std::endl;
		std::cout << "EEG Data Extraction from EmoEngine"	   << std::endl;
		std::cout << "===================================================================" << std::endl;
		...
		std::cout << "Start receiving EEG Data (for 100 sample)... \n" << std::endl;
			...
			if (readytocollect) {
						...
						if (nSamplesTaken != 0) {
							...
							for (int sampleIdx=0 ; sampleIdx<(int)nSamplesTaken ; ++ sampleIdx) {
								//for (int i = 1 ; i<sizeof(targetChannelList)/sizeof(EE_DataChannel_t) ; i++) { // try for 1=1 to 15
